...
header('Location: Fail.html');
	...
	$insert_value = 'INSERT INTO `' . $db_name . '`.`'.$db_table_name.'` (`Nombre` , `ApellidoPaterno` ,`ApellidoMaterno` ,`Direccion` ,`Municipio` ,`Estado` ,`CURP` ,`Licenciatura` , `Email`,`Foto`) VALUES ("' . $subs_name . '", "' . $subs_last . '", "' . $subs_last2 . '","' . $subs_direccion . '","' . $subs_municipio . '","' . $subs_estado . '","' . $subs_curp . '","' . $subs_licenciatura . '","' . $subs_foto . '","' . $subs_email . '")';
